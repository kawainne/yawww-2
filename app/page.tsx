      ...
      <div className="max-w-7xl mx-auto px-6 pt-32">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <FeatureCard
            ...
            badge="new"
            keyFeatures={[
              { value: "98%", label: "Akurasi Terbaru" },
              { value: "0.3s", label: "Response Time" },
              { value: "100+", label: "Species Database" }
            ]}
          >
          ...
          <FeatureCard
            ...
            badge="improved"
            keyFeatures={[
              { value: "1000+", label: "Materi Terbaru" },
              { value: "4K", label: "Visual Quality" },
              { value: "AI", label: "Learning Path" }
            ]}
          >
            <button className="px-3 py-1.5 text-sm bg-indigo-500/10 rounded-lg hover:bg-indigo-500/20 transition-colors">
              Mulai Belajar
          ...
          <FeatureCard
            ...
            keyFeatures={[
              ...
              { value: "Personal", label: "Learning Path" }
            ]}
          >
            <button className="px-3 py-1.5 text-sm bg-indigo-500/10 rounded-lg hover:bg-indigo-500/20 transition-colors">
              Lihat Progress
